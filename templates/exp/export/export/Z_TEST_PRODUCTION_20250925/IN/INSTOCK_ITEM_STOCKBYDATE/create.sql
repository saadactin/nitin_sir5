CREATE Procedure Instock_item_StockByDate
(IN ToDate datetime)
LANGUAGE SQLSCRIPT 
...
t0."DocDate" <= :ToDate
  group by t0."ItemCode",T0."Warehouse",t1."WhsName",t2."AvgPrice",t2."ItemName",T2."ItemCode",T2."OnHand"
