Create Procedure CSV1_DELTA()
As
Begin
		Delete From ETL_SALES_LINES T0 Where DocType = 166 And EXISTS(SELECT "DocEntry" FROM CSV1_DELTA_TABLE TEMP
		...
		Select 166,				
				...
				INNER JOIN CSV1_DELTA_TABLE TEMP ON TEMP."DocEntry" = T6."DocEntry" AND TEMP."LineNum" = T6."LineNum"
 				Left Outer Join 
 					(
