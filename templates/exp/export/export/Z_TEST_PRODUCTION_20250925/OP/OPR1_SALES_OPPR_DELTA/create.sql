create procedure OPR1_SALES_OPPR_DELTA() language SQLSCRIPT as
begin
		opprs = Select Distinct "OpprId" as "OpprId" From  OPR1_SALES_OPPR_DELTA_TABLE Where "OPT" = 'I' Or "OPT" = 'U';
		delete from "ETL_SALES_OPPR" where "OPPORTUNITY_ID" IN (SELECT "OpprId" FROM :opprs);
		...
		INSERT INTO "ETL_SALES_OPPR" 
			...
			INNER JOIN :opprs TEMP ON TEMP."OpprId" = T0."OpprId";	
